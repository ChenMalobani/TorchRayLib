...
//    /// The standard font face (default: ``"sans"`` from ``resources/SpectralSC-Regular.ttf``).
//    int m_font_sans_regular_001;
//    /// The bold font face (default: ``"sans-bold"`` from ``resources/SpectralSC-Bold.ttf``).
//    int m_font_sans_bold_001;
