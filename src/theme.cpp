...
Theme::Theme(NVGcontext *ctx) {
    ...
    m_font_sans_regular = nvgCreateFontMem(ctx, "sans", (uint8_t *) spectralsc_regular_ttf,
                                           roboto_regular_ttf_size, 0);
    m_font_sans_bold = nvgCreateFontMem(ctx, "sans-bold", (uint8_t *) spectralsc_bold_ttf,
