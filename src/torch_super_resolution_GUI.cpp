...
int main() {
    ...
    const char * torchStyle="torch.rgs";
...
//                ImageFormat(&image,UNCOMPRESSED_R8G8B8A8);
        ...
        if (GuiButton(Rectangle{screenWidth - 190, screenHeight - 320, 150, 40}, "SAVE")) {
        ...
        if (GuiButton(Rectangle{screenWidth - 190, screenHeight - 50, 150, 40}, "SR")) {
...
//            windowBoxActive = true;
        ...
        if (GuiButton(Rectangle{screenWidth - 190, screenHeight - 100, 150, 40}, "Candy")) {
            PlaySound(clickSound);
        ...
        if (GuiButton(Rectangle{screenWidth - 190, screenHeight - 150, 150, 40}, "Mosaic")) {
            PlaySound(clickSound);
        ...
        if (GuiButton(Rectangle{screenWidth - 190, screenHeight - 200, 150, 40}, "Darker")) {
            PlaySound(clickSound);
        ...
        if (GuiButton(Rectangle{screenWidth - 190, screenHeight - 250, 150, 40}, "Lighter")) {
            PlaySound(clickSound);
